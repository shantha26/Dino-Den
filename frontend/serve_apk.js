    ...
    res.end(`
      ...
      <head>
        ...
        <style>
          ...
          .btn { display: block; background: #3b82f6; color: #ffffff; padding: 1rem 1.5rem; border-radius: 0.75rem; font-weight: 600; text-decoration: none; font-size: 1.1rem; transition: background 0.2s; box-shadow: 0 4px 6px -1px rgba(59, 130, 246, 0.5); }
          .btn:active { background: #2563eb; transform: translateY(1px); }
        </style>
      </head>
      <body>
        <div class="card">
